...
[release-readiness-checks](../backlog/release-readiness-checks.md). Verified three ways:
...
[release-readiness-checks](../backlog/release-readiness-checks.md), turns that vigilance
