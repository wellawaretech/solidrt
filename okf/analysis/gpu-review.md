...
- **The split object model** (2026-07-30): `compileShader` -> `linkProgram`
  ...
  [gpu-pipeline-object-model](../backlog/gpu-pipeline-object-model.md)
...
- **Sampler state** (2026-07-29): per-texture `filter` (linear|nearest) and
  ...
  [gpu-sampler-state](../backlog/gpu-sampler-state.md)
- **Dependency propagation** (2026-07-29): sampler bindings are live edges;
  ...
  [gpu-target-dependency-propagation](../backlog/gpu-target-dependency-propagation.md)
...
- **Pass timing, stage 1** (2026-07-30): `gpuPasses`/`gpuPassMs` in
  get_stats. [gpu-pass-timing](../backlog/gpu-pass-timing.md)
...
([extensions](../backlog/gpu-pipeline-extensions.md)) or MSAA
...
When [index buffers](../backlog/gpu-pipeline-extensions.md) arrive, follow
...
- **Modern-style 3D** (translucency, large meshes, post-processing,
  ...
  [gpu-pipeline-extensions](../backlog/gpu-pipeline-extensions.md), now
...
[gpu-pipeline-object-model](../backlog/gpu-pipeline-object-model.md), and a
